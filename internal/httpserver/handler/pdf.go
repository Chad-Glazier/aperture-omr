...
//
// TODO: Find a way to remove the repeated logic. A generic approach probably
// exists. Currying?
//
...
func PostScanPdfJob(s ServerResources) JobHandlerFunc {
	return func(w http.ResponseWriter, r *http.Request, j JobResources) {
		...
		j.SetNotes(
			fmt.Sprintf("rendering %d %d-page exams", nExams, pagesPerExam),
		)
